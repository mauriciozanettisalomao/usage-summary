...
```bash
summary-usage$ sam logs -n StockCheckerFunction --stack-name summary-usage --tail
```
...
```bash
summary-usage$ go test -v ./functions/...
```
...
```bash
aws cloudformation delete-stack --stack-name summary-usage
```
